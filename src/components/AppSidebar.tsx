...
const mainNav: NavItem[] = [
  ...
  { href: "/more", label: "Explore", icon: LayoutGrid },
];
...
function SidebarNav() {
  ...
  return (
    <SidebarContent>
      ...
      <SidebarGroup className="mt-auto shrink-0 pb-2">
        <SidebarGroupContent>
          <p className="px-2 text-xs text-muted-foreground leading-relaxed">
            Looking for something? Everything lives in{" "}
            <Link to="/more" className="font-medium text-primary hover:underline">
              Explore
            </Link>
            .
          </p>
